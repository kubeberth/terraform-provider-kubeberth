...
require (
	github.com/kubeberth/kubeberth-go v0.11.0
	k8s.io/api v0.24.0
...
require (
	...
	github.com/kubeberth/kubeberth-apiserver v0.11.0 // indirect
	github.com/kubeberth/kubeberth-operator v0.11.0 // indirect
